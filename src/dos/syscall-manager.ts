...
export class SyscallManager {
  ...
  get exports() {
    return {
      ...
      0x35: [
        getInterruptVector,
        [[I286.REGISTER_AL, 1, Number]],
        [[[I286.REGISTER_ES, I286.REGISTER_BX]]],
        false,
      ],
      ...
      // CF set on error
      // AX <- error code (on error)
      0x3e: [close, [[I286.REGISTER_BX, 2, Number]], [], true],
  ...
  invoke() {
    ...
    console.log(
      ...
      'ah=',
      this._machine.cpu.core.ah.toString(16) + 'h',
      'al=',
      this._machine.cpu.core.al.toString(16) + 'h',
      'bx=',
      this._machine.cpu.core.bx.toString(16),
      'cx=',
      this._machine.cpu.core.cx.toString(16),
      'ds=',
      this._machine.cpu.core.ds.toString(16),
      'dx=',
      this._machine.cpu.core.dx.toString(16)
    );
    ...
    if (handler) {
      ...
      console.log('error: Unknown DOS call', this._machine.cpu.core.ax.toString(16));
      return true;
    }
  }
}
