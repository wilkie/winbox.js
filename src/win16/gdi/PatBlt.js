...
export function PatBlt(hdc, nLeftRect, nTopRect, nwidth, nheight, fdwRop) {
    ...
    switch (fdwRop) {
        ...
        case Gdi.WHITENESS:
            // Fill rectangle
            surface.bitmap.blit(Bitmap.OPERATIONS.COPY, nLeftRect, nTopRect, nwidth, nheight, new Color(255, 255, 255), 0, 0, nwidth, nheight);
            break;

        case Gdi.BLACKNESS:
            // Fill rectangle with black
            surface.bitmap.blit(Bitmap.OPERATIONS.COPY, nLeftRect, nTopRect, nwidth, nheight, new Color(0, 0, 0), 0, 0, nwidth, nheight);
            break;
    }
