...
export class I286 {
    ...
    retrieveDescriptor(segment) {
        ...
        console.log("16-bit descriptor:", "base=", segmentBase.toString(16), "limit=", segmentLimit.toString(16), "flags=", gdtFlags.toString(16));
    ...
    execute(instruction) {
        ...
        switch (opcode) {
            ...
            case 0x69:    // IMUL rw,ew,dw
                {
                    const imulResult = this._alu.imul16(this.readOperand16(instruction),
