...
export class I286 implements CpuCore16 {
  ...
  declare _cpu: any;
  declare _flags: any;
  declare _gdtBase: any;
  declare _gdtLimit: any;
  declare _idtBase: any;
  declare _idtLimit: any;
  declare _instruction: any;
  declare _ip: any;
  declare _ivt: any;
  declare _ldtBase: any;
  declare _ldtLimit: any;
  declare _memory: any;
  declare _msw: any;
  ...
  declare ldt: any;
  declare static REGISTERS_G16: any;
  declare static REGISTERS_G8: any;
  declare static REGISTERS_S: any;
  declare static REGISTER_AH: any;
  declare static REGISTER_AL: any;
  declare static REGISTER_AX: any;
  declare static REGISTER_BH: any;
  declare static REGISTER_BL: any;
  declare static REGISTER_BP: any;
  declare static REGISTER_BX: any;
  declare static REGISTER_CH: any;
  declare static REGISTER_CL: any;
  declare static REGISTER_CS: any;
  declare static REGISTER_CX: any;
  declare static REGISTER_DH: any;
  declare static REGISTER_DI: any;
  declare static REGISTER_DL: any;
  declare static REGISTER_DS: any;
  declare static REGISTER_DX: any;
  declare static REGISTER_ES: any;
  declare static REGISTER_SI: any;
  declare static REGISTER_SP: any;
  declare static REGISTER_SS: any;
  constructor(cpu, options = {}) {
    this._cpu = cpu;
    this._memory = cpu.memory;
    this._alu = new ALU(this);

    this._registers = [0, 0, 0, 0, 0, 0, 0, 0];
    this._segmentRegisters = [0, 0, 0, 0];
   ...
   */
  pop16() {
    const ret = this.read16(this.ss, this.sp);
    this.sp = this.sp + 2;
    return ret;
  }
  ...
  execute(instruction) {
    ...
    switch (opcode) {
      ...
      case 0x30: // XOR eb,rb
        ...
        this.debug(
          [
            ['add', 'adc', 'and', 'xor'],
            ['or ', 'sbb', 'sub', 'unk'],
          ][(opcode & 0xf) == 0x8 ? 1 : 0][opcode >> 4] + '   eb,rb'
        );

        this.writeOperand8(
          instruction,
          operation(this.readOperand8(instruction), this.readRegister8(instruction.sourceRegister))
        );
      ...
      case 0x31: // XOR ew,rw
        ...
        this.debug(
          [
            ['add', 'adc', 'and', 'xor'],
            ['or ', 'sbb', 'sub', 'unk'],
          ][(opcode & 0xf) == 0x9 ? 1 : 0][opcode >> 4] + '   ew,rw'
        );
      ...
      case 0x32: // XOR rb,eb
        ...
        this.debug(
          [
            ['add', 'adc', 'and', 'xor'],
            ['or ', 'sbb', 'sub', 'unk'],
          ][(opcode & 0xf) == 0xa ? 1 : 0][opcode >> 4] + '   rb,eb'
        );

        this.writeRegister8(
          instruction.sourceRegister,
          operation(this.readRegister8(instruction.sourceRegister), this.readOperand8(instruction))
        );
        break;
      ...
      case 0x33: // XOR rw,ew
        ...
        this.debug(
          [
            ['add', 'adc', 'and', 'xor'],
            ['or ', 'sbb', 'sub', 'unk'],
          ][(opcode & 0xf) == 0xb ? 1 : 0][opcode >> 4] + '   rw,ew'
        );
      ...
      case 0x34: // XOR AL,db
        ...
        this.debug(
          [
            ['add', 'adc', 'and', 'xor'],
            ['or ', 'sbb', 'sub', 'unk'],
          ][(opcode & 0xf) == 0xc ? 1 : 0][opcode >> 4] + '   AL,db'
        );

        this.writeRegister8(
          I286.REGISTER_AL,
          operation(this.readRegister8(I286.REGISTER_AL), instruction.immediate)
        );
        break;
      ...
      case 0x35: // XOR AX,dw
        ...
        this.debug(
          [
            ['add', 'adc', 'and', 'xor'],
            ['or ', 'sbb', 'sub', 'unk'],
          ][(opcode & 0xf) == 0xd ? 1 : 0][opcode >> 4] + '   AX,dw'
        );
      ...
      case 0x85: // TEST ew,rw / TEST rw,ew
        ...
        this.debug(
          (opcode == 0x39 ? 'cmp ' : 'test') + '   ew,rw',
          instruction,
          this.readOperand16(instruction),
          this.readRegister16(instruction.sourceRegister)
        );

        operation(this.readOperand16(instruction), this.readRegister16(instruction.sourceRegister));
        break;
      ...
      case 0x80: // ADC eb,db / ADD eb,db / AND eb,db / CMP eb,db /
        ...
        switch (instruction.modifier) {
          ...
          case 0x6: // XOR eb,db
            ...
            this.debug(
              ['add', 'or ', 'adc', 'sbb', 'and', 'sub', 'xor', 'unk'][instruction.modifier] +
                '   eb,db'
            );

            this.writeOperand8(
              instruction,
              operation(this.readOperand8(instruction), instruction.immediate)
            );
            break;

          case 0x7: // CMP eb,db
            this._alu.sub8(this.readOperand8(instruction), instruction.immediate);
            break;
        }
      ...
      case 0x81: // ADC ew,dw / ADD ew,dw / AND ew,dw / CMP ew,dw /
        ...
        switch (instruction.modifier) {
          ...
          case 0x6: // XOR ew,dw
            ...
            this.writeOperand16(
              instruction,
              operation(this.readOperand16(instruction), instruction.immediate)
            );
            break;

          case 0x7: // CMP ew,dw
            this.debug('cmp    ew,dw');
            this._alu.sub16(this.readOperand16(instruction), instruction.immediate);
            break;
        }
        break;
      ...
      case 0x8a: // MOV rb,eb
        ...
        this.writeRegister8(instruction.sourceRegister, this.readOperand8(instruction));
        break;
      ...
      case 0xd3: // RCL ew,CL / RCR ew,CL / ROL ew,CL / ROR ew,CL /
        ...
        this.writeOperand16(instruction, operation(this.readOperand16(instruction), shiftAmount));
        break;
      ...
      case 0xc5: // LDS rw,ed (Load EA dword into DS/rw)
        ...
        if (opcode == 0xc4) {
          ...
          this.debug(
            'lds    rw,eb',
            instruction.segment.toString(16),
            instruction.offset.toString(16),
            this.readOperand16(instruction).toString(16),
            this.read16(instruction.segment, instruction.offset + 2).toString(16)
          );
          this.ds = this.read16(instruction.segment, instruction.offset + 2);
        }
        break;
      ...
      case 0xc7: // MOV ew,dw
        this.debug(
          'mov    ew,dw',
          instruction.immediate.toString(16),
          instruction.segment,
          this.di,
          instruction.offset
        );
      ...
      case 0xf6: // DIV eb / IDIV eb / IMUL eb / MUL eb /
        ...
        switch (instruction.modifier) {
          ...
          case 0x2: // NOT eb
            this.debug('not    eb   ');
            this.writeOperand8(instruction, this._alu.not8(this.readOperand8(instruction)));
            break;
          case 0x3: // NEG eb
            this.debug('neg    eb   ');
            this.writeOperand8(instruction, this._alu.neg8(this.readOperand8(instruction)));
            break;
          case 0x4: // MUL eb
            this.debug('mul    eb   ');
            this.ax = this._alu.mul8(this.al, this.readOperand8(instruction));
            break;
          case 0x5: // IMUL eb
            this.debug('imul   eb   ');
            this.ax = this._alu.imul8(this.al, this.readOperand8(instruction));
            break;
          case 0x6: // DIV eb
            this.debug('div    eb   ');
      ...
      case 0xf7: // DIV ew / IDIV ew / IMUL ew / MUL ew /
        ...
        switch (instruction.modifier) {
          ...
          case 0x2: // NOT ew
            this.debug('not    ew   ');
            this.writeOperand16(instruction, this._alu.not16(aluWordOperand));
            break;
          case 0x3: // NEG ew
            this.debug('neg    ew   ');
      ...
      case 0x2f6: // TEST eb,db
        ...
        this._alu.and8(this.readOperand8(instruction), instruction.immediate);
        break;

      case 0x4f7: // TEST ew,dw
        this.debug('test   ew,dw');
        this._alu.and16(this.readOperand16(instruction), instruction.immediate);
        break;
      ...
      case 0xfe: // INC eb / DEC eb
        ...
        switch (instruction.modifier) {
          case 0:
            this.writeOperand8(instruction, this._alu.inc8(this.readOperand8(instruction)));
            break;
          case 1:
            this.writeOperand8(instruction, this._alu.dec8(this.readOperand8(instruction)));
            break;
          default:
            throw new InvalidInstruction(instruction);
        }
      ...
      case 0xff: // CALL ew / CALL far ed / DEC ew / INC ew /
        ...
        switch (instruction.modifier) {
          ...
          case 0x1: // DEC ew
            ...
            this.writeOperand16(instruction, operation(this.readOperand16(instruction)));
            break;
        ...
        switch (instruction.modifier) {
          ...
          case 2: // LGDT m
            ...
            if (this.cpl == 0) {
              ...
              this.gdtBase =
                (this.read16(instruction.segment, instruction.offset + 2) << 8) |
