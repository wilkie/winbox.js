 ...
 * thirty-one pixels, and three stretched outlines of `widths` of one or two
 * pixels each; see FONTS.md. Each may only come down. */
const STYLES_OUTLINE_RECORDS = 10 + 3;
const STYLES_OUTLINE_PIXELS = 10 + 4;
