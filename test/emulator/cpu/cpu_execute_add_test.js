    ...
    describe('#execute', () => {
        ...
        describe('add eb,rb', function() {
            it ('should execute the instruction with register source', function() {
                ...
                // It should invoke the ALU 'add' operation with the appropriate
                // arguments.
                let spy = spyOn(ALU.prototype, 'add8').and.callThrough();

                this.instruction = this.cpu.decode(this.instruction);
                this.cpu.execute(this.instruction)

                expect(this.cpu.alu.add8).toHaveBeenCalledWith(a, b);
            });
        ...
        describe('add AX,db', function() {
            it ('should execute the instruction', function() {
                ...
                // It should invoke the ALU 'add' operation with the appropriate
                // arguments.
                let spy = spyOn(ALU.prototype, 'add16').and.callThrough();

                this.instruction = this.cpu.decode(this.instruction);
                this.cpu.execute(this.instruction)

                expect(this.cpu.alu.add16).toHaveBeenCalledWith(a, b);
            });
        });

        describe('add ew,dw', function() {
            it ('should execute the instruction with register source', function() {
