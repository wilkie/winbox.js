...
export function assertInstruction() {
  expect(this.instruction.displacement).toEqual(this.checkInstruction.displacement);
  expect(this.instruction.offset).toEqual(this.checkInstruction.offset);
  expect(this.instruction.operandRegister).toEqual(this.checkInstruction.operandRegister);
  expect(this.instruction.segment).toEqual(this.checkInstruction.segment);
  expect(this.instruction.immediate).toEqual(this.checkInstruction.immediate);
}
